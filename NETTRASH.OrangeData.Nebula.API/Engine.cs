...
namespace NETTRASH.OrangeData.Nebula.API
{
    ...
    public class Engine
    {
        ...
        public async Task<Result<Response.DeviceGroup.List>> DeviceGroupListAsync(Request.DeviceGroup.List request)
        {
            HttpRequestMessage message = new HttpRequestMessage();
            message.Content = request.GetContent();
            message.Method = request.GetMethod();
        ...
        public async Task<Result<Response.DeviceGroup.Add>> DeviceGroupAddAsync(Request.DeviceGroup.Add request)
        {
            HttpRequestMessage message = new HttpRequestMessage();
            message.Content = request.GetContent();
            message.Method = request.GetMethod();
        ...
        public async Task<Result<Response.DeviceGroup.Change>> DeviceGroupChangeAsync(Request.DeviceGroup.Change request)
        {
            HttpRequestMessage message = new HttpRequestMessage();
            message.Content = request.GetContent();
            message.Method = request.GetMethod();
        ...
        public async Task<Result<Response.DeviceGroup.Delete>> DeviceGroupDeleteAsync(Request.DeviceGroup.Delete request)
        {
            HttpRequestMessage message = new HttpRequestMessage();
            message.Content = request.GetContent();
            message.Method = request.GetMethod();
        ...
        public async Task<Result<Response.DeviceGroup.Get>> DeviceGroupGetAsync(Request.DeviceGroup.Get request)
        {
            HttpRequestMessage message = new HttpRequestMessage();
            message.Content = request.GetContent();
            message.Method = request.GetMethod();
        ...
        public async Task<Result<Response.DeviceGroup.List>> DeviceGroupGetAsync(Request.DeviceGroup.GetByOrganization request)
        {
            HttpRequestMessage message = new HttpRequestMessage();
            message.Content = request.GetContent();
            message.Method = request.GetMethod();
