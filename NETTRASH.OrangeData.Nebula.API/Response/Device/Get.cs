...
{
    [JsonObject]
    public class Get : Base, Interfaces.IDeviceInfo
    {
        #region Private properties



        private Classes.Device.StateInfo _state { get; set; }
        ...
        [JsonConverter(typeof(Classes.Device.StateInfo))]
        public Interfaces.IDeviceStateInfo State
        {
            ...
            set
            {
                _state = new Classes.Device.StateInfo(value);
            }
        }
        ...
        public static Get Load(string sSourceJson)
        {
            try
            {
